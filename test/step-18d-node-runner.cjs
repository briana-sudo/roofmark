...
const {
  ...
  distanceFromSegment,
  // 18d-pivot's findPivotSnapTarget was renamed to findTechSnapTarget
  // in 18d-edit (May 11 2026); aliased here so the 18d-pivot tests
  // below keep their signature compatible with the new exporter.
  // 18d-pivot's resolveTechPivot was deleted entirely; the older
  // tests in this file that exercised it have been retired alongside
  // the pivot UI in 18d-edit. The remaining geometry tests (centroid,
  // hit-test, rotation) all survive intact.
  findTechSnapTarget,
} = loadModule(
